...
possibleEdgeLab.grid(row = 4, column = 12, columnspan = 6)

chosenEdgeLab = Label(root, text = "Edges: " + str(len(ChosenEdges)), fg = 'black', bg = 'cyan')
chosenEdgeLab.grid(row = 5, column = 12, columnspan = 4)

choicesLeft = Label(root, text = "Choices Left: " + str(len(PossibleEdges)-k), fg= 'black', bg='cyan')
choicesLeft.grid(row = 3, column = 12, columnspan = 5 )

img_lbl = Label(root, text = '                                                                                              ', fg = 'black', bg = 'white')
img_lbl.grid(row = 7, column = 12, columnspan = 40)
img_lbl.config(height = 1, width = 120)

edgeToBeAdded = Label(root, text = 'Add Edge:', fg= 'black', bg = 'cyan').grid(row = 1, column = 11, columnspan = 5)

mincol = Label(root, text = '', bg = 'white')
mincol.grid(row = 8, column = 12, columnspan = 8)
mincol.config(height = 1, width = 15)
...
def Calculate():
    ...
    x = g.chromaticPoly()
    chi = g.chi(x)
    mincol.config(text = 'X(G)= ' + str(chi))
    img_lbl.config(text = 'P(k)= '+str(x) )
   # obj = BytesIO()
   # sympy.preview(x, viewer='BytesIO', output = 'png', outputbuffer=obj, euler = False)
   # obj.seek(0)
